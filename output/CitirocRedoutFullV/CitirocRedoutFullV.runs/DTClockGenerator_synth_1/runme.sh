...
HD_PWD='/home/utente/projects/CitirocRedoutFullV/CitirocRedoutFullV.runs/DTClockGenerator_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DTClockGenerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DTClockGenerator.tcl
