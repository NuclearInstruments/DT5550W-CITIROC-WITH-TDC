...
HD_PWD='/home/utente/projects/CitirocRedoutFullV/CitirocRedoutFullV.runs/FTDI_FIFO_AW_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FTDI_FIFO_AW.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FTDI_FIFO_AW.tcl
