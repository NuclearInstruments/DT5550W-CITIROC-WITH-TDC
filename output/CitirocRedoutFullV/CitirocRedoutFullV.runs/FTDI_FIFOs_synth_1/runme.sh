...
HD_PWD='/home/utente/projects/CitirocRedoutFullV/CitirocRedoutFullV.runs/FTDI_FIFOs_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FTDI_FIFOs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FTDI_FIFOs.tcl
