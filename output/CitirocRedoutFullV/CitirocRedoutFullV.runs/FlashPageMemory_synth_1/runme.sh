...
HD_PWD='/home/utente/projects/CitirocRedoutFullV/CitirocRedoutFullV.runs/FlashPageMemory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FlashPageMemory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FlashPageMemory.tcl
