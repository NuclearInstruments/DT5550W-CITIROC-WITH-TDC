...
HD_PWD='/home/utente/projects/CitirocRedoutFullV/CitirocRedoutFullV.runs/TestBram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestBram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestBram.tcl
