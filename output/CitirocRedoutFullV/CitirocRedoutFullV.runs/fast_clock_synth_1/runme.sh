...
HD_PWD='/home/utente/projects/CitirocRedoutFullV/CitirocRedoutFullV.runs/fast_clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fast_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fast_clock.tcl
