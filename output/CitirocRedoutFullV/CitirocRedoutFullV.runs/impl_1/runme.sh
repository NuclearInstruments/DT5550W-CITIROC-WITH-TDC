...
HD_PWD='/home/utente/projects/CitirocRedoutFullV/CitirocRedoutFullV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_CitirocRedoutFullV.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_CitirocRedoutFullV.tcl -notrace
