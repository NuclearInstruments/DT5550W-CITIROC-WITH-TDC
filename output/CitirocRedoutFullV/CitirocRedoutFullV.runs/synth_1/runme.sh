...
HD_PWD='/home/utente/projects/CitirocRedoutFullV/CitirocRedoutFullV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_CitirocRedoutFullV.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_CitirocRedoutFullV.tcl
