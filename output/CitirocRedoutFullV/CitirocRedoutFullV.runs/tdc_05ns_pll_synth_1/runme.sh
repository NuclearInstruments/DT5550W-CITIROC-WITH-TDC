...
HD_PWD='/home/utente/projects/CitirocRedoutFullV/CitirocRedoutFullV.runs/tdc_05ns_pll_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tdc_05ns_pll.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tdc_05ns_pll.tcl
